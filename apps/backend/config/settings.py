...
RESEND_PROJECT_INVITATION_TEMPLATE_ID = env("RESEND_PROJECT_INVITATION_TEMPLATE_ID", default="")
RESEND_PROJECT_INVITATION_ACCEPTED_TEMPLATE_ID = env("RESEND_PROJECT_INVITATION_ACCEPTED_TEMPLATE_ID", default="")
RESEND_PASSWORD_RESET_TEMPLATE_ID = env("RESEND_PASSWORD_RESET_TEMPLATE_ID", default="")
RESEND_EMAIL_VERIFICATION_TEMPLATE_ID = env("RESEND_EMAIL_VERIFICATION_TEMPLATE_ID",default="",)
