...
from .views.expense_requests import (
    ...
    ExpenseRequestTrashListView,
    ExpenseRequestRestoreView,
)
...
urlpatterns = [
    ...
    path("projects/<int:project_id>/calendar/subscription/", ProjectCalendarSubscriptionView.as_view(), name="project-calendar-subscription"),
    path("calendar/<str:token>.ics", ProjectCalendarFeedView.as_view(), name="project-calendar-feed"),
    # Financial Entries
    ...
    path("projects/<int:project_id>/expense-requests/trash/", ExpenseRequestTrashListView.as_view(), name="project-expense-requests-trash"),
    ...
    path("projects/<int:project_id>/expense-requests/<int:pk>/restore/", ExpenseRequestRestoreView.as_view(), name="project-expense-request-restore"),
