    ...
    <main className="min-h-dvh bg-background px-6 py-10 text-foreground">
      <div className="mx-auto grid min-h-[calc(100dvh-5rem)] w-full max-w-5xl items-center gap-10 lg:grid-cols-[1fr_440px]">
        <section className="hidden lg:block">
          ...
          <div className="mt-8 grid max-w-xl grid-cols-3 gap-3 text-sm">
            <div className="rounded-md border bg-card p-4">
              ...
              <p className="mt-1 text-muted-foreground">Vue centrale</p>
            </div>
            <div className="rounded-md border bg-card p-4">
              <p className="font-semibold">Dossiers</p>
              <p className="mt-1 text-muted-foreground">Structure</p>
            </div>
            <div className="rounded-md border bg-card p-4">
              <p className="font-semibold">Equipe</p>
              <p className="mt-1 text-muted-foreground">Acces</p>
            </div>
          </div>
        </section>
        ...
        <div className="w-full">
          ...
          <div className="[&_.rounded-xl]:rounded-lg [&_input]:h-11">
            {children}
          </div>
        </div>
      </div>
